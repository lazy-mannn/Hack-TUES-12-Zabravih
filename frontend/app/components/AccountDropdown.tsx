...
export default function AccountDropdown({ email }: Props) {
  ...
  return (
    <div className="relative" ref={ref}>
      <button
        onClick={() => setOpen(o => !o)}
        className="flex items-center gap-1.5 text-xs font-semibold tracking-widest uppercase px-4 py-2 h-8 rounded-lg text-amber-800 border-2 border-amber-300 bg-amber-50/70 hover:bg-amber-100 hover:border-amber-400 transition-all"
      >
