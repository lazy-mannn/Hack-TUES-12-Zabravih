...
- Next.js фронтенд с графично изобразяване на данните
- ESP32-S3 firmware, събиращ температура, влажност, CO2 и аудио
...
1. ESP32-S3 устройството в кошера събира сензорни данни и записва 10-секунден аудио файл
2. Данните се изпращат към Django API чрез HTTPS multipart POST
3. Django стартира YAMNet ML модел, който анализира аудиото и определя статуса на майката:
- Queen Not Present (QNP)
- Queen Present and Newly Accepted (QPNA)
- Queen Present and Rejected (QPR)
- Queen Present (Original) (QPO)
5. Резултатите се съхраняват в PostgreSQL и се визуализират чрез Next.js
6. Пчеларят вижда графики за здравето на кошера и статус на майката от последния запис (отпреди максимално 30мин)

## Демо

[https://zabravih.org](https://zabravih.org)
